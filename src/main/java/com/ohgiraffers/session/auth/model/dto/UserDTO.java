package com.ohgiraffers.session.auth.model.dto;
...
*   이를 참조할 수 있는 '위치(location)'를 제공하기 위한 편리 목적으로 설계 되었다.
*   덕분에 해당 구현체는 다양한 보안 기능(재정의 가능한 메소드 7개 참고)을 제공하고 확장할 수 있게 되었다.
*  */
public class UserDTO implements UserDetails {
    ...
    /* 설명. 권한 정보를 반환하는 메소드
    *   UsernamePasswordAuthenticationToken에 사용자의 권한 정보를 반환할 때 사용 된다.
    *  */
    @Override
    public Collection<? extends GrantedAuthority> getAuthorities() {

        /* 설명. 인증 된 사용자에게 부여할 권한 컬렉션(List) */
        Collection<GrantedAuthority> authorities = new ArrayList<>();
        /* 설명. userRole.getRole()의 타입은 String이지만 authorities의 타입은 GrantedAuthority이기 때문에 형변환을 위한 람다식 */
    ...
    /* 설명. 사용자의 아이디를 반환하는 메소드
     *   UsernamePasswordAuthenticationToken과 사용자의 아이디를 비교할 때 사용 된다.
     *  */
    @Override
